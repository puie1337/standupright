...
local INPUTBG = Color3.fromRGB(10,   9,  20)
local WHITE   = Color3.new(1, 1, 1)
local TOGOFF  = Color3.fromRGB(30,  26,  48)
local DIM     = Color3.fromRGB(65,  58, 100)
local MUTED   = Color3.fromRGB(100, 90, 145)
...
sendNowBtn.BackgroundColor3 = Color3.fromRGB(25, 110, 195)
